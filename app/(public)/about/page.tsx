        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-grey">
              <p>
                কুরআন পড়া শেখা প্রতিটি মুসলিমের জীবনের একটি গুরুত্বপূর্ণ অংশ।
                কিন্তু ব্যস্ত জীবনে অনেকেই নিয়মিত ক্লাস করতে পারেন না, কিংবা
                হয়তো একেবারে কোথা থেকে শুরু করবেন তা জানেন না।
              </p>
              <p>
                ইলমুরা ইনস্টিটিউট সেই ভয় দূর করার জন্য তৈরি। আমাদের কাছে
                যেকোনো বয়সের শিক্ষার্থী, একেবারে হরফ চেনা থেকে শুরু করে
                তাজবীদসহ শুদ্ধ তিলাওয়াত — সব স্তরের কোর্সের সুযোগ পায়, সব
                ঘরে বসে, লাইভ ক্লাসে।
              </p>
            </div>
